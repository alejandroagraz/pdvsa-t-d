...
function WebTrends(){
  ...
  this.onsitedoms=".medlineplus.gov";
  this.downloadtypes="exe,dll,com,zip,pdf,arc,bin,sit,tar,gz,z,arj,rpm,rar,doc,mpeg,mp3,avi,mp2,hqx,wav,mp4,txt,xml,tif,mpg,m4v,mov,wmv,f4v,magpie,smil,ogg";
...
WebTrends.prototype.dcsMultiTrack=function(){
  ...
  if (args.length%2==0){
    ...
    if ("theORG"==args[0]) {
      this.DCS.theORG = args[1];
      this.DCS.theURL = args[3];
    }
    this.dcsFPC();
    this.dcsTag();
  ...
  if (evt&&((typeof(evt.which)!="number")||(evt.which==1))){
    ...
    if (e.href){
        ...
        if ((hn.length>0)&&(pr.indexOf("http")==0)&&!this.dcsIsOnsite(hn)){
          var qry=e.search?e.search.substring(e.search.indexOf("?")+1,e.search.length):"";
          var pth=e.pathname?((e.pathname.indexOf("/")!=0)?"/"+e.pathname:e.pathname):"/";
          var _name = e.getAttribute("name");
          if (/theORG/i.test(_name)) {
            var _t = _name.split("_");
            theORG = _t[_t.length-1];
            theURL = e.href;
          }
          if (""==theORG) {
            ...
            this.dcsMultiTrack("theORG",theORG,"theURL",theURL,"DCS.dcssip", hn, "DCS.dcsuri", pth, "DCS.dcsqry", this.trimoffsiteparams ? "" : qry, "DCS.dcsref", window.location, "WT.ti", "Offsite:" + hn + pth + (qry.length ? ("?" + qry) : ""), "WT.dl", "24", "WT.nv", this.dcsNavigation(evt));
          }
        }
    }
  }
